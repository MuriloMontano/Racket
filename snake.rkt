...
(define POINT-TEXT (text/font (number->string COUNTER) POINT-TEXT-SIZE "red" "Gill Sans" 'swiss 'normal 'bold #f))

(define MT-SCENE
  (rectangle WIDTH-PX HEIGHT-PX "solid" "black"))

(define GOO-IMG (rectangle 20 20 "solid" "Chartreuse"))
(define SEG-IMG  (rectangle 20 20 "solid" "gray"))
(define HEAD-IMG (rectangle 20 20 "solid" "gray"))
(define HEAD-LEFT-IMG HEAD-IMG)
(define HEAD-DOWN-IMG (rotate 90 HEAD-LEFT-IMG))
(define HEAD-RIGHT-IMG (flip-horizontal HEAD-LEFT-IMG))
(define HEAD-UP-IMG (flip-vertical HEAD-DOWN-IMG))

(define ENDGAME-TEXT-SIZE 25)

(define (random-goos)
   (create-goos-list (+ 5 (random 4))))

(define (create-goos-list n)
  (if (zero? n) empty
      (cons (fresh-goo) (create-goos-list (- n 1)))))
...
(define (increment!) 
  ...
  (set! POINT-TEXT (text/font (number->string COUNTER) POINT-TEXT-SIZE "red" "Gill Sans" 'swiss 'normal 'bold #f)))
...
(define (render-pit w)
  (place-image/align POINT-TEXT (* 1 SEG-SIZE) 1 "center" "top"
...
(define (render-end w)
  (define ENDGAME-TEXT (string-append "Sua pontuação foi: " (number->string COUNTER)))  
  (overlay (text/font ENDGAME-TEXT ENDGAME-TEXT-SIZE "red" "Gill Sans" 'swiss 'normal 'bold #f)
           (render-pit w)))
...
(big-bang (pit (snake "down" (list (posn 10 1)))
               (random-goos))
